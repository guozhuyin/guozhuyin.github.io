...
export const schemas = {
 profile: { label: '基本資料', single: true, fields: {
  name: bi('公開名稱／綽號'), intro: bi('首頁標題', true), summary: bi('首頁簡介', true), focus: bi('求職方向'), residence: bi('居住地'), about: bi('關於', true), quote: text('個人名言（保留原文）'), quoteLanguage:{label:'名言原文語言（例如 zh-Hant）',type:'languageTag'},
 ...
 articles:{label:'文章入口',fields:{title:bi('文章標題'),summary:bi('文章摘要',true),category:bi('分類'),date:text('日期'),featured:{label:'放在首頁精選',type:'boolean'},url:link('WordPress 原文網址'),cover:image('封面圖片'),coverAlt:bi('封面圖片說明')}},
